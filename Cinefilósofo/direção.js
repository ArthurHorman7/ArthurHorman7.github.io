function sobre(){
    ...
    if(select.selectedIndex == 0){
        ...
        img.src = `imagens/gifpoderoso.gif`
        ...
        img.src = "imagens/gifchaplin.gif"
        img.style.maxWidth= '450px'
        ...
        img.src = 'imagens/giftarantino.gif'
