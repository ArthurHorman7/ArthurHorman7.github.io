function recomendar(){    
    ...
    if(g[1].checked){
        ...
        if(select.selectedIndex == 0){
            modo = 'Ação'
            img.setAttribute('src', 'indica filmes/logan.png')
            document.body.style.background = 'gray'
            rei.innerHTML = 'Logan'
        
        }else if(select.selectedIndex == 1){
            modo = 'Animação'
            img.setAttribute('src','indica filmes/tumulo.png')
            ...
            modo = 'Aventura'
            img.setAttribute('src', 'indica filmes/contacomigo.png')
            ...
            //comédia
                modo ='Comédia'
                img.setAttribute('src', 'indica filmes/eueumesmoeirene.png')
            ...
            //cult
            modo ='Cult'
                img.setAttribute('src', 'indica filmes/mrnobody.png')
            ...
            //documentário
            modo ='Documentário'
                img.setAttribute('src', 'indica filmes/hitler.png')
            ...
            //drama
            modo ='Drama'
                img.setAttribute('src', 'indica filmes/rock.png')
                document.body.style.background = 'gray'
            ...
            //gospel
            modo ='Gospel'
                img.setAttribute('src', 'indica filmes/fazendeiro.png')
            ...
            //histórico
            modo ='Histórico'
                img.setAttribute('src', 'indica filmes/pianista.png')
            ...
            //esporte
            modo ='esporte'
                img.setAttribute('src', 'indica filmes/titas.png')
            ...
            //espionagem
            modo ='espionagem'
                img.setAttribute('src', 'indica filmes/impossivel.png')
            ...
            //fantasia
            modo ='fantasia'
                img.setAttribute('src', 'indica filmes/beowulf.png')
            ...
            //faroeste
            modo ='Faroeste'
                img.setAttribute('src', 'indica filmes/django.png')
            ...
            modo ='Ficção científica'
                img.setAttribute('src', 'indica filmes/interestelar.png')
            ...
            //musical
            modo ='Musical'
                img.setAttribute('src', 'indica filmes/miseraveis.png')
            ...
            //noir
            modo ='Noir'
                img.setAttribute('src', 'indica filmes/city.png')
            ...
            //Policial
            modo ='Policial'
                img.setAttribute('src', 'indica filmes/treinamento.png')
            ...
            //Pornográfico
            modo ='Pornográfico'
                img.setAttribute('src', 'indica filmes/xvideos.png')
                document.body.style.background = 'black'
            ...
            //romance
            modo ='Romance'
                img.setAttribute('src', 'indica filmes/fogo.png')
            ...
            //suspense
            modo ='Suspense'
                img.setAttribute('src', 'indica filmes/seven.png')
            ...
            //terror
            modo ='Terror'
                img.setAttribute('src', 'indica filmes/babadook.png')
                document.body.style.background = 'black'
